...
, normalSize = (
    ...
    superexpandednumArray: [2, 2, 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 8, 8, 8, 9, 9, 9, 10, 10, 10, 11, 11, 11, 12, 12, 2, 2,2,12,12,12,12],
...
, generateTileContent = () => {
    ...
    d.probability = "";
    a.push(d);
    if (mode === "expanded" || mode === "super_expanded") a.push(d);
    return shuffle(a);
}
, buildTiles = () => {
