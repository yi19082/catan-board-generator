...
17.5), expandedSize = 16, resourceTypes = ["ore", "sheep", "brick", "wood", "wheat", "desert"], adjacencyList, size, modeElement = document.getElementById("selected-map"), imageTypeElement = document.getElementById("image_option_input"), IMAGETHEMECHOSEN = "", mode, shuftype = (mode = null == modeElement ? "normal" : modeElement.value,
size = "normal" == mode ? normalSize : expandedSize,
"random"), adjacent_6_8 = !1, adjacent_2_12 = !0, adjacent_same_numbers = !0, adjacent_same_resource = !0, settingAdjusted = !1, setMenuValues = () => {
...
, generateTileContent = () => {
    let e, t;
    t = "normal" == mode ? (e = shuffle(this.state.numArray),
    shuffle(this.state.resourceArray)) : (e = shuffle(this.state.expandednumArray),
    shuffle(this.state.expandedresourceArray));
    var s, r = this.state.prob, a = [];
    for (s in e) {
        var o = Object();
        o.chit = e[s],
        o.resource = t[s],
        o.probability = r[o.chit],
        a.push(o)
    }
    var d = Object();
    return d.resource = "desert",
    d.chit = "",
    d.probability = "",
    a.push(d),
...
, shuffleIsValid = e => {
    let t = !0;
    if (t = adjacent_same_resource || "normal" != mode ? t && passedResourceCheck(e, 2) : t && passedResourceCheck(e, 1),
    !adjacent_6_8 && !(t = t && passedAdjacencyTest(e, 6, 8)))
        return !1;
    if (adjacent_2_12 || (t = t && passedAdjacencyTest(e, 2, 12)),
    !adjacent_same_numbers)
        for (var s of state.regNums)
            if (!(t = t && passedAdjacencyTest(e, s, s)))
                return !1;
    return t
}
, fillTiles = () => {
    ...
    for (var [t,s] of e.entries()) {
        var r, a = document.getElementById("tile-" + t), t = document.getElementById("circle-" + t);
